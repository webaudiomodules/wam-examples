...
import MidiVirtualKeyboardNoSoundHTMLElement from './Gui.js';

export { MidiVirtualKeyboardNoSoundHTMLElement };
...
// any DOM node
	return new MidiVirtualKeyboardNoSoundHTMLElement(plugin, ...args);
}
