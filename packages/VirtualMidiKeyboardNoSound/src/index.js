...
// DSP part
import MidiVirtualKeyboardNoSoundNode from './Node.js';
// GUI part
...
export default class MidiVirtualKeyboardPlugin extends WebAudioModule {
	...
	async createAudioNode(initialState) {
		...
		// of nodes.
		const midiVirtualKeyboardNode = new MidiVirtualKeyboardNoSoundNode(this.audioContext);
		...
		midiVirtualKeyboardNode.setup(paramMgrNode);

		// If there is an initial state at construction for this plugin,
		if (initialState) midiVirtualKeyboardNode.setState(initialState);

		return midiVirtualKeyboardNode;
	}
