/** @typedef {import('./api/types').RingBufferConstructor} RingBufferConstructor */
...
export default class WamEventRingBuffer {
	/**
...
if (globalThis.AudioWorkletGlobalScope) {
	globalThis.WamEventRingBuffer = WamEventRingBuffer;
}
