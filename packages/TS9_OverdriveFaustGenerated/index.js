    ...
    class TS9_OverdriveFaustGeneratedNode extends CompositeAudioNode {
  ...
  export default class TS9_OverdriveFaustGeneratedPlugin extends WebAudioModule {
	    static descriptor = {
		    name: 'TS9_OverdriveFaustGenerated',
      ...
      async initialize(state) {
        ...
        const paramMgrNode = await ParamMgrFactory.create(this, { internalParamsConfig: Object.fromEntries(faustNode.parameters) });
		    const node = new TS9_OverdriveFaustGeneratedNode(this.audioContext);
