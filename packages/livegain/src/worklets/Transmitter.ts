...
import processorURL from "omt:./Transmitter.worklet.ts"; // eslint-disable-line import/extensions
...
export const processorID = "__WebAudioModule_LiveGain_Transmitter";
export class TransmitterNode extends AudioWorkletProxyNode<ITransmitterNode, ITransmitterProcessor, TransmitterParameters> {
