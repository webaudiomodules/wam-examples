import processorURL from "omt:./TemporalAnalyser.worklet.ts"; // eslint-disable-line import/extensions, import/no-unresolved
...
export const processorID = "__WebAudioPlugin_TemporalAnalyser";
